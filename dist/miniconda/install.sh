...
./bin/conda create --yes --name python3 python=3.6.2 pandas
#./bin/conda install -n python3 pip
. ./bin/activate python3
pip install --upgrade pip
pip install git+https://bitbucket.org/snakemake/snakemake.git
pip install drmaa
rm -f ./envs/python3/lib/python3.6/site-packages/snakemake/jobscript.sh
ln -s `pwd`/../snakemake/cluster/UGE/jobscript.sh ./envs/python3/lib/python3.6/site-packages/snakemake/jobscript.sh
. ./bin/deactivate
